...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise-063) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; posn -> number
; 计算ap到原点的距离
; --- -- ---
(check-expect (distance-to-0 (make-posn 0 5)) 5)
(check-expect (distance-to-0 (make-posn 2 0)) 2)
