...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise-083~085) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (edit e ke)
  (cond
    ...
    [(key=? ke "\t") e]
    [(key=? ke "\r") e]
    [(= (string-length ke) 1) (add-left e ke)]
    [else e]))
